...
import { useSafe } from "src/hooks";

const EnablePlugin = () => {
	const { savePluginAddress, savePluginEnabled } = useContext(UserDataContext);
	const { enableModuleOnSafe, enablePluginOnProtocolManager, addModule } =
		useSafe();
			...
			<Box textAlign="center" alignItems="center">
				<Button
					...
					onClick={async () => {
						...
						const res3 = await enablePluginOnProtocolManager(_pluginAddress);
						if (!res3.result) {
